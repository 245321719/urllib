...
var bds={
    ...
    comm : {
        ...
        query : "",
        dpquery: "",
        qid : "987b667600000941",
        cid : "0",
        sid : "1431_21084_18560_17001_24880_22074",
        indexSid : "1431_21084_18560_17001_24880_22074",
        stoken : "",
        serverTime : "1510712248",
        user : "",
        username : "",
        userid : "0",
        loginAction : [],
        ...
        pinyin : "",
        favoOn : "",
        cookie : {"BAIDUID":"8EF74C2D426CEC488DBBB723E73E574E:FG=1","BIDUPSID":"D9E141A930DC38B55D9D68BD9451CA93","PSTM":"1488890348","FP_UID":"e49b93cffd7d102d84aabdb39f0796e3","H_PS_PSSID":"1431_21084_18560_17001_24880_22074","BDSVRTM":"0","BD_HOME":"0"},
        ...
        globalLogFlag:0
	,encTn:'6e52zpiJOsrMIYYVph2TY8lSaLQ31jAe4hiGcaLOiYiAOecQhmLDzcEkaoE'    }
};
...
<script>if(window.bds&&bds.util&&bds.util.setContainerWidth){bds.util.setContainerWidth();}</script><div id="head"><div class="head_wrapper"><div class="s_form"><div class="s_form_wrapper"><div id="lg"><img hidefocus="true" src="//www.baidu.com/img/bd_logo1.png" width="270" height="129"></div><a href="/" id="result_logo" onmousedown="return c({'fm':'tab','tab':'logo'})"><img src="//www.baidu.com/img/baidu_jgylogo3.gif" alt="到百度首页" title="到百度首页"></a><form id="form" name="f" action="/s" class="fm"><input type="hidden" name="ie" value="utf-8"><input type="hidden" name="f" value="8"><input type="hidden" name="rsv_bp" value="1"><input type="hidden" name="rsv_idx" value="1"><input type=hidden name=ch value=""><input type=hidden name=tn value="baidu"><input type=hidden name=bar value=""><span class="bg s_ipt_wr"><input id="kw" name="wd" class="s_ipt" value="" maxlength="255" autocomplete="off"></span><span class="bg s_btn_wr"><input type="submit" id="su" value="百度一下" class="bg s_btn"></span><span class="tools"><span id="mHolder"><div id="mCon"><span>输入法</span></div><ul id="mMenu"><li><a href="javascript:;" name="ime_hw">手写</a></li><li><a href="javascript:;" name="ime_py">拼音</a></li><li class="ln"></li><li><a href="javascript:;" name="ime_cl">关闭</a></li></ul></span></span><input type="hidden" name="rn" value=""><input type="hidden" name="oq" value=""><input type="hidden" name="rsv_pq" value="da3f85a5000026ac"><input type="hidden" name="rsv_t" value="dd83MC4dytaAUDGiEBj5N6G8mlFyIWpBf1zFn8irhcMdWf0FUB9LD0494Js"><input type="hidden" name="rqlang" value="cn"></form><div id="m"></div></div></div><div id="u"><a class="toindex" href="/">百度首页</a><a href="javascript:;" name="tj_settingicon" class="pf">设置<i class="c-icon c-icon-triangle-down"></i></a><a href="https://passport.baidu.com/v2/?login&tpl=mn&u=http%3A%2F%2Fwww.baidu.com%2F" name="tj_login" class="lb" onclick="return false;">登录</a></div><div id="u1"><a href="http://news.baidu.com" name="tj_trnews" class="mnav">新闻</a><a href="http://www.hao123.com" name="tj_trhao123" class="mnav">hao123</a><a href="http://map.baidu.com" name="tj_trmap" class="mnav">地图</a><a href="http://v.baidu.com" name="tj_trvideo" class="mnav">视频</a><a href="http://tieba.baidu.com" name="tj_trtieba" class="mnav">贴吧</a><a href="http://xueshu.baidu.com" name="tj_trxueshu" class="mnav">学术</a><a href="https://passport.baidu.com/v2/?login&amp;tpl=mn&amp;u=http%3A%2F%2Fwww.baidu.com%2F" name="tj_login" class="lb" onclick="return false;">登录</a><a href="http://www.baidu.com/gaoji/preferences.html" name="tj_settingicon" class="pf">设置</a><a href="http://www.baidu.com/more/" name="tj_briicon" class="bri" style="display: block;">更多产品</a></div></div></div>
...
var bds={
    ...
    comm : {
        ...
        query : "",
        dpquery: "",
        qid : "da3f85a5000026ac",
        cid : "0",
        sid : "1444_21100_17001_24879_22157",
        indexSid : "1444_21100_17001_24879_22157",
        stoken : "",
        serverTime : "1510712567",
        user : "",
        username : "",
        userid : "0",
        loginAction : [],
        ...
        pinyin : "",
        favoOn : "",
        cookie : {"BAIDUID":"C1AE176E4453173CA2E3B455328A3C1C:FG=1","BIDUPSID":"04BAE5367ADB059A1B45BA54B85B1F5A","PSTM":"1510661911","H_PS_PSSID":"1444_21100_17001_24879_22157","BD_UPN":"1123314351","BDSVRTM":"0","BD_HOME":"0"},
        userAgent : "Mozilla/5.0 (Windows; U; zh-CN) AppleWebKit/533.19.4 (KHTML, like Gecko) AdobeAIR/27.0",
                curResultNum:"0",
        rightResultExist:false,
        protectNum:0,
        ...
        flagTranslateResult:0,
        globalLogFlag:0
	,encTn:'dd83MC4dytaAUDGiEBj5N6G8mlFyIWpBf1zFn8irhcMdWf0FUB9LD0494Js'    }
};
...
>>> response = urllib2.rlopen(request)

Traceback (most recent call last):
  File "<pyshell#18>", line 1, in <module>
    response = urllib2.rlopen(request)
AttributeError: 'module' object has no attribute 'rlopen'
>>> response = urllib2.urlopen(request)
>>> print response.read()
...
<html>
  <head>
    ...
    <link type="text/css" rel="stylesheet" href="/css/bootstrap.css;jsessionid=D01283E91CA9C80ACF48C3EA6B06404A.tomcat1" />
    <link type="text/css" rel="stylesheet" href="/css/login.css;jsessionid=D01283E91CA9C80ACF48C3EA6B06404A.tomcat1" />
    <link type="text/css" rel="stylesheet" href="/css/weixinqr.css;jsessionid=D01283E91CA9C80ACF48C3EA6B06404A.tomcat1" />
  ...
  <body>
            ...
            <div class="login-part">
              ...
              <div class="user-info">
                <div class="user-pass">
                  ...
                  <form id="fm1" action="/account/login;jsessionid=D01283E91CA9C80ACF48C3EA6B06404A.tomcat1?from=http://my.csdn.net/my/mycsdn" method="post">
					...
					<input type="hidden" name="lt" value="LT-575357-Kj2dc290R19yazyMNViI5m5iOfeoJi" />
              ...
              <div class="third-part tracking-ad" data-mod="popu_27">
              	...
              	<a id="qqAuthorizationUrl" href="https://graph.qq.com/oauth2.0/authorize?response_type=code&client_id=100270989&redirect_uri=https%3A%2F%2Fpassport.csdn.net%2Faccount%2Flogin%3Foauth_provider%3DQQProvider&state=test" class="qq"></a>
                   	...
                   	<script src="/js/apps/weixinqr.js;jsessionid=D01283E91CA9C80ACF48C3EA6B06404A.tomcat1"></script>
    ...
    <script data-main="/js/login-config.js;jsessionid=D01283E91CA9C80ACF48C3EA6B06404A.tomcat1" src="/js/libs/require.js;jsessionid=D01283E91CA9C80ACF48C3EA6B06404A.tomcat1"></script>
    <script type="text/javascript">
...
<html>
  <head>
    ...
    <link type="text/css" rel="stylesheet" href="/css/bootstrap.css;jsessionid=094B98ACD31C0F3308D9A9C9FB286872.tomcat2" />
    <link type="text/css" rel="stylesheet" href="/css/login.css;jsessionid=094B98ACD31C0F3308D9A9C9FB286872.tomcat2" />
    <link type="text/css" rel="stylesheet" href="/css/weixinqr.css;jsessionid=094B98ACD31C0F3308D9A9C9FB286872.tomcat2" />
    <script src="https://res.wx.qq.com/connect/zh_CN/htmledition/js/wxLogin.js"></script>
    <!--[if lt IE 9]>
    <script src="https://oss.maxcdn.com/libs/html5shiv/3.7.0/html5shiv.js"></script>
    <script src="https://oss.maxcdn.com/libs/respond.js/1.3.0/respond.min.js"></script>
  ...
  <body>
            ...
            <div class="login-part">
              ...
              <div class="user-info">
                <div class="user-pass">
                  ...
                  <form id="fm1" action="/account/login;jsessionid=094B98ACD31C0F3308D9A9C9FB286872.tomcat2?from=http://my.csdn.net/my/mycsdn" method="post">
                    ...
                    <!-- 该参数可以理解成每个需要登录的用户都有一个流水号。只有有了webflow发放的有效的流水号，用户才可以说明是已经进入了webflow流程。否则，没有流水号的情况下，webflow会认为用户还没有进入webflow流程，从而会重新进入一次webflow流程，从而会重新出现登录界面。 -->
					<input type="hidden" name="lt" value="LT-576229-CRjyc6fOg1xe7ePaLKBoiplLOmJrDr" />
			 		<input type="hidden" name="execution" value="e1s1" /> 
					<input type="hidden" name="_eventId" value="submit" /> 
					<input class="logging" accesskey="l" value="登 录" tabindex="6" type="button" /> 
              ...
              <div class="third-part tracking-ad" data-mod="popu_27">
              	...
              	<a id="qqAuthorizationUrl" href="https://graph.qq.com/oauth2.0/authorize?response_type=code&client_id=100270989&redirect_uri=https%3A%2F%2Fpassport.csdn.net%2Faccount%2Flogin%3Foauth_provider%3DQQProvider&state=test" class="qq"></a>
                   	...
                   	<a id="wechatAuthorizationUrl" href="javascript:void(0)" onClick="show();" class="wechat" target="_parent"></a>
                   	<script src="/js/apps/weixinqr.js;jsessionid=094B98ACD31C0F3308D9A9C9FB286872.tomcat2"></script>
    ...
    <div class="footer"></div>
    <script data-main="/js/login-config.js;jsessionid=094B98ACD31C0F3308D9A9C9FB286872.tomcat2" src="/js/libs/require.js;jsessionid=094B98ACD31C0F3308D9A9C9FB286872.tomcat2"></script>
    <script type="text/javascript">
		document.write('<script type="text/javascript" src="//csdnimg.cn/pubfooter/js/publib_footer.js?' + Math.floor(new Date()/120000).toString(36) + '="></'+'script>');
	</script>
  </body>
...
<html>
  <head>
    ...
    <link type="text/css" rel="stylesheet" href="/css/bootstrap.css;jsessionid=74EC1D8F0F6ED843A42FC7A47869CA2B.tomcat1" />
    <link type="text/css" rel="stylesheet" href="/css/login.css;jsessionid=74EC1D8F0F6ED843A42FC7A47869CA2B.tomcat1" />
    <link type="text/css" rel="stylesheet" href="/css/weixinqr.css;jsessionid=74EC1D8F0F6ED843A42FC7A47869CA2B.tomcat1" />
    <script src="https://res.wx.qq.com/connect/zh_CN/htmledition/js/wxLogin.js"></script>
    <!--[if lt IE 9]>
    <script src="https://oss.maxcdn.com/libs/html5shiv/3.7.0/html5shiv.js"></script>
    <script src="https://oss.maxcdn.com/libs/respond.js/1.3.0/respond.min.js"></script>
  ...
  <body>
            ...
            <div class="login-part">
              ...
              <div class="user-info">
                <div class="user-pass">
                  ...
                  <form id="fm1" action="/account/login;jsessionid=74EC1D8F0F6ED843A42FC7A47869CA2B.tomcat1?username=1016903103%40qq.com&amp;password=XXXX" method="post">
                    ...
                    <!-- 该参数可以理解成每个需要登录的用户都有一个流水号。只有有了webflow发放的有效的流水号，用户才可以说明是已经进入了webflow流程。否则，没有流水号的情况下，webflow会认为用户还没有进入webflow流程，从而会重新进入一次webflow流程，从而会重新出现登录界面。 -->
					<input type="hidden" name="lt" value="LT-576454-5wt963W5asRQs6YALE5lcdapRkXUJC" />
			 		<input type="hidden" name="execution" value="e1s1" /> 
					<input type="hidden" name="_eventId" value="submit" /> 
					<input class="logging" accesskey="l" value="登 录" tabindex="6" type="button" /> 
              ...
              <div class="third-part tracking-ad" data-mod="popu_27">
              	...
              	<a id="qqAuthorizationUrl" href="https://graph.qq.com/oauth2.0/authorize?response_type=code&client_id=100270989&redirect_uri=https%3A%2F%2Fpassport.csdn.net%2Faccount%2Flogin%3Foauth_provider%3DQQProvider&state=test" class="qq"></a>
                   	...
                   	<a id="wechatAuthorizationUrl" href="javascript:void(0)" onClick="show();" class="wechat" target="_parent"></a>
                   	<script src="/js/apps/weixinqr.js;jsessionid=74EC1D8F0F6ED843A42FC7A47869CA2B.tomcat1"></script>
    ...
    <div class="footer"></div>
    <script data-main="/js/login-config.js;jsessionid=74EC1D8F0F6ED843A42FC7A47869CA2B.tomcat1" src="/js/libs/require.js;jsessionid=74EC1D8F0F6ED843A42FC7A47869CA2B.tomcat1"></script>
    <script type="text/javascript">
		document.write('<script type="text/javascript" src="//csdnimg.cn/pubfooter/js/publib_footer.js?' + Math.floor(new Date()/120000).toString(36) + '="></'+'script>');
	</script>
  </body>
